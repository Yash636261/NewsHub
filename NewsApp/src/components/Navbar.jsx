...
const navbar= ()=> {
  ...
  const chageToggle= ()=>{
    ...
    return (
      ...
      <nav className='w-full flex flex-col border bg-[#1f1f1f] border-transparent rounded-lg drop-shadow-sm'>
  <div className='bg-[url("../images/Navbar.jpg")] p-3 border border-transparent rounded-lg shadow-md'>
    <div className="container mx-auto flex justify-between">
      ...
      <button className="text-white md:hidden bg-black w-8 h-8 border-0 rounded-md p-1 my-auto"  onClick={chageToggle} type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        <svg
                className="w-6 h-6"
                aria-hidden="true"
                fill="currentColor"
...
{Toggle && (
  <div className='w-32 border-0  rounded-xl mt-2 text-white bg-[#1f1f1f]'>
  <div className=" text-sm font-bold mx-auto" id="navbarSupportedContent">
    <ul className="flex flex-col mx-2 border-0 p-2 rounded-lg drop-shadow-lg backdrop-blur-sm">
      <li className="mr-4"><Link className="text-white hover:text-gray-400" aria-current="page" to="/">Home</Link></li>
      <li className="mr-4"><Link className=" hover:text-gray-400" to="/entertainment">Entertainment</Link></li>
      <li className="mr-4"><Link className=" hover:text-gray-400" to="/general">Business</Link></li>
      <li className="mr-4"><Link className=" hover:text-gray-400" to="/health">Health</Link></li>
      <li className="mr-4"><Link className=" hover:text-gray-400" to="/science">Science</Link></li>
