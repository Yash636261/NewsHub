    ...
    return (
      <Router basename="/">
        <div className='px-[5%] py-5 bg-[#292a2d] min-h-screen'>
          <Navbar/>
          <Routes>
            <Route exact path="/" element={<NewsSec key="genera" ishome="yes" pageSize={6} country="in" category="general" CategoryImage="https://lh3.ggpht.com/MMoPETUaDbUB1bO3KAi3cKQ_lzssju3VEp9ZPauGIamgSniMr4nV2SVkVvG-rKUJSLQJP84q7EA=s56-rw-p"/>}></Route>
            ...
            <Route exact path="/general" element={<NewsSec key="business" pageSize={6} country="in" category="business" CategoryImage="https://lh3.ggpht.com/MMoPETUaDbUB1bO3KAi3cKQ_lzssju3VEp9ZPauGIamgSniMr4nV2SVkVvG-rKUJSLQJP84q7EA=s56-rw-p"/>}></Route>
